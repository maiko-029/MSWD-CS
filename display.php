...
<body id="page-top">
          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
              <div class="table-responsive">
                <table class="table" id="dataTable" width="100%" cellspacing="0" name="dt">
  ...
  <script type="text/javascript">
         $.getJSON("fetch.php?whatToFetch=client", function(data) {
            console.log(data);
            var tr;
            for (var i = 0; i < data.length; i++) {
                ...
                tr.append("<td>" + data[i].lname + "</td>");
                tr.append("<td>" + data[i].age + "</td>")
                tr.append("<td>" + data[i].gender + "</td>");
                tr.append("<td>" + data[i].address + "</td>");
                tr.append("<td>" + data[i].birthdate + "</td>");
                tr.append("<td>" + data[i].birthplace + "</td>");
                tr.append("<td>" + data[i].religion + "</td>");
                tr.append("<td>" + data[i].cnumber + "</td>");
                tr.append("<td>" + data[i].sector + "</td>");
